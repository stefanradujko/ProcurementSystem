...
public class FormaLogIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Prijavljivanje zaposlenog");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(pFPass, javax.swing.GroupLayout.DEFAULT_SIZE, 225, Short.MAX_VALUE))
    ...
    private void btnLogInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLogInActionPerformed
        ...
        Kontroler.getInstanca().prijavljivanje(user, pass);
    ...
    private void pokreniCekanje() {
        CekajOdgovor co = new CekajOdgovor(this);
        co.start();
    }

    public void neuspesnoPrijavljivanje() {
        JOptionPane.showMessageDialog(this, "Neuspešno prijavljivanje");
    }

    public GlavnaKlijentskaForma uspesnoPrijavljivanje() {
        JOptionPane.showMessageDialog(this, "Uspešno prijavljivanje");
        GlavnaKlijentskaForma gkf = new GlavnaKlijentskaForma();
        gkf.setLocationRelativeTo(null);
        gkf.setVisible(true);
        txtFUser.setText("");
        pFPass.setText("");
        dispose();
